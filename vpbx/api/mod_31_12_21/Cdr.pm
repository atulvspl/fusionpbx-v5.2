...
sub getcdrbynumbers () {
	...
	$response{data}{total} = $hash{1}{total} ? $hash{1}{total} : 0;
	 ...
	 $fields1 = 'uuid,uuid,b_call_id,a_call_id,caller_id_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,queue_extension,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';
