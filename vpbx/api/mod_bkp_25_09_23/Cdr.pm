...
sub getcdr () {
	...
	$fields = 'xml_cdr_uuid,xml_cdr_uuid,b_call_id,caller_id_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,queue_extension,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';
	...
	$fields1 = 'xml_cdr_uuid,xml_cdr_uuid,sip_call_id,caller_id_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,call_center_queue_uuid,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';
...
sub getcdrbynumbers () {
	...
	for (keys %post_add) {
		...
		# ADDED BY ATUL
			...
			$phone_number =~s/;/','/ig;
			$phone_number="'".$phone_number."'";
			$condition1="(caller_id_number IN ($phone_number)";
			$condition1.="OR caller_id_name IN ($phone_number)";
			$condition1.="OR destination_number IN ($phone_number))";
	...
	$response{data}{total} = $hash{1}{total} ? $hash{1}{total} : 0;
	 ...
	 $fields1 = 'xml_cdr_uuid,xml_cdr_uuid,b_call_id,caller_id_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,queue_extension,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';
	# $fields1 = 'uuid,uuid,b_call_id,a_call_id,caller_id_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,call_center_queue_uuid,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';

	$fields = 'xml_cdr_uuid,xml_cdr_uuid,sip_call_id,caller_id_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,call_center_queue_uuid,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';
	#$fields = 'uuid,uuid,call_id,a_leg_call_id,alternate_cid_name,caller_id_number,destination_number,start_stamp,billsec,pdd_ms,rtp_audio_in_mos,hangup_cause,start_epoch,cc_queue,queue_extension,direction,bridge_uuid,sip_hangup_disposition,answer_stamp';
	if ($response{stat} ne 'fail') {
